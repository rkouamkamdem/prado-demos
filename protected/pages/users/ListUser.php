...
class ListUser extends TPage
{
    ...
    public function onInit($param)
    {
        ...
        {
            //récupère le nombre total de Users
            $this->Repeater->VirtualItemCount=UserRecord::finder()->count();
    ...
    protected function populateData()
    {
        ...
        $this->Repeater->DataSource=$this->getUsers($offset,$limit);
     ...
     */
    protected function getUsers($offset, $limit)
    {
